...
#define ALIEN_X_SEPARATION 2 //REVISAR CUANDO VEAMOS FRONT DE LA RPI
...
#define BULLET_MOVE_INTERVAL 20
...
#define ALIEN_MAX_MOVE_INTERVAL 15
#define ALIEN_MIN_MOVE_INTERVAL 2
