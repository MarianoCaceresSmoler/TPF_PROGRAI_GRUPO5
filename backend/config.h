...
#define ALIEN_SEPARATION (4/3 * ALIEN_WIDTH)
#define BARRIERS_INITIAL_X (SCREEN_SIZE / 9)
#define BARRIERS_INITIAL_Y (SHIP_INITIAL_Y - SHIP_HEIGHT - BARRIER_HEIGHT * BARRIER_PIXEL_HEIGHT)
